...
initial_text="ما یه تیم هستیم متشکل از دوتا روانشناس و مثلا سه متخصص هوش مصنوعی  و این چت بات رو طراحی کردیم تا بتونیم ذره ای از دغدغه های شما را کم، و حالتون را بهتر کنیم. \nو برامون خیلی مهمه که این چت بات بتونه اثر بخش باشه، برای همین از شما کمک میخوایم،  \nچه کمکی؟ کاری که باید بکنید اینه که در مجموع ۳ نوبت پرسشنامه پر بکنید  و روزی ۱۰ الی ۱۵ دقیقه هم از چت بات استفاده کنید و سعی کنید در زمینه افسردگی ازش کمک بگیرید.و کل این فرایند فقط ۲ هفته طول میکشه  \n .  و اما شما چی به دست میارین؟ \n۱/میتونین به صورت رایگان از جلسات درمانی که براتون گذاشته میشه استفاده بکنید \n . ۲/در صورتی که تمام و کمال همکاری بکنید هدیه نقدی هم براتون در نظر گرفتیم  \n 😉پس اگر به مدت ۲ هفته میتونین روزی ۱۰ الی ۱۵ دقیقه زمان بزارین، برای اطلاعات بیشتر :پیام بدین \n . 💢فقط یه نکته ۴ روز بیشتر فرصت ندارین تا تصمیمتون رو به ما اعلام کنید."
